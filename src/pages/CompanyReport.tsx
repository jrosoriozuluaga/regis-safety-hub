  ...
  useEffect(() => {
    ...
    async function loadReport() {
      ...
      setReport({
        ...
        pilaCargadas: pilas.filter((p: any) => p.estado === "cargada").length,
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 print:grid-cols-4 print:gap-2">
            ...
            <Card className="print:shadow-none print:border">
              <CardContent className="pt-4 text-center print:py-2">
                ...
                <div className="text-2xl font-bold print:text-xl">{report.pilaCargadas}/{report.pilaTotal}</div>
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="text-center">
                      {report.pilaCargadas > 0
                        ? <CheckCircle2 className="h-4 w-4 text-emerald-600 mx-auto" />
                        : <Circle className="h-4 w-4 text-muted-foreground mx-auto" />}
                    </TableCell>
                    <TableCell className="text-center tabular-nums">{report.pilaCargadas} / {report.pilaTotal}</TableCell>
                    <TableCell className="text-sm text-muted-foreground">
                      {report.pilaTotal - report.pilaCargadas > 0
                        ? `${report.pilaTotal - report.pilaCargadas} pendiente(s)`
                        : "Al día"}
                    </TableCell>
                  </TableRow>
                  <TableRow>
